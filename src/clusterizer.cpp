...
meshopt_Bounds meshopt_computeClusterBounds(const unsigned int* indices, size_t index_count, const float* vertex_positions, size_t vertex_count, size_t vertex_positions_stride)
{
	...
	bounds.cone_axis_s8[0] = int8_t(meshopt_quantizeSnorm(bounds.cone_axis[0], 8));
	bounds.cone_axis_s8[1] = int8_t(meshopt_quantizeSnorm(bounds.cone_axis[1], 8));
	bounds.cone_axis_s8[2] = int8_t(meshopt_quantizeSnorm(bounds.cone_axis[2], 8));
	...
	bounds.cone_cutoff_s8 = (cone_cutoff_s8 > 127) ? 127 : int8_t(cone_cutoff_s8);
